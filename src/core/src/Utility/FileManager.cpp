...
auto FileManager::get_rom() -> std::vector<std::uint8_t>
{
...
auto FileManager::get_prg_ram() -> std::vector<std::uint8_t>
{
...
auto FileManager::get_palette() -> std::vector<std::uint8_t>
{
...
auto FileManager::get_app_path() const -> std::filesystem::path { return app_path; }

auto FileManager::get_rom_path() const -> std::filesystem::path { return rom_path; }

auto FileManager::get_patch_path() const -> std::filesystem::path { return patch_path; }

auto FileManager::get_prg_ram_path() const -> std::filesystem::path { return prg_ram_path; }

auto FileManager::get_palette_path() const -> std::filesystem::path { return palette_path; }

auto FileManager::get_snapshot_path() const -> std::filesystem::path { return snapshot_path; }

auto FileManager::has_patch() const -> bool { return std::filesystem::exists(patch_path); }

auto FileManager::has_prg_ram() const -> bool { return std::filesystem::exists(prg_ram_path); }

auto FileManager::has_snapshot() const -> bool { return std::filesystem::exists(snapshot_path); }
}  // namespace nes::Utility
